...
public class NeoTunnes {
	...
	private void selectUser() {
		...
		if (option2 == 2 ) {
			...
			controller.showUsersPremium();
			controller.showUsersStandart();
	...
	private void registerPodcast() {
		...
		System.out.println("select type of podcast \n"
							+ "[1] ENTERTAINMENT \n"
							+ "[2] FASHION \n"
							+ "[3] GAME \n"
							+ "[4] POLITCS \n");
		String typeTemp = reader.nextLine();
		int type = Integer.parseInt(typeTemp);
		System.out.println("give a description");
		String description = reader.nextLine();
		
		controller.registerPodcast(name, album, duration, url, type, description);
		
		System.out.println("registered sucessfully");
		
		// name, album,  duration,  urlPicture, type, descrption
